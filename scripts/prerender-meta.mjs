...
function renderRoute({ title, description, keywords, path, jsonLd, noindex }) {
  ...
  if (keywords) {
    html = html.replace(/(<meta name="keywords" content=")[^"]*(")/, `$1${escapeAttr(keywords)}$2`)
  }
